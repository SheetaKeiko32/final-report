...
# Laser setup
Laser = turtle.Turtle()
window.addshape(r'/Users/mac/Desktop/final-report/laser.gif')  # Remove extra spaces in filename
Laser.shape(r'/Users/mac/Desktop/final-report/laser.gif')
Laser.goto(0, -210)
Laser.hideturtle()
Laser_state = 'ready'
...
for _ in range(5):
    Alien = turtle.Turtle()
    window.addshape(r'/Users/mac/Desktop/final-report/e1.gif')  # Remove extra spaces in filename
